...
const Header = ({ isCompactPermanent = false }) => {
  const isScrolled = useScrollPosition(5, 654);
  ...
  const shouldCompact = isCompactPermanent || isScrolled;

  return (
    <>
      <header className={`header ${shouldCompact  ? "compact" : ""}`}>
        <div className="header__container o-container o-container--margin">
          <a className="header__left" href="./index.html">
            ...
            <svg
              ...
              className="header__logo header__logo--min-screen"
            >
              <path
        ...
        <div className="modal" id="modal-destinos" hidden>
          Contenido de destinos
        </div>
        <div className="modal" id="modal-checkin" hidden>
          Contenido de check-in
        </div>
        <div className="modal" id="modal-checkout" hidden>
          Contenido de check-out
        </div>
        <div className="modal" id="modal-huespedes" hidden>
