...
const PropertyDetail = ({ place, host, destination }: PropertyDetailProps) => {
  return (
    <div className="c-property">
      <header className="c-property__header">
        <h2 className="c-property__type">
          Alojamiento entero: {place.type} en {destination?.city}, Perú
        </h2>
        <p className="c-property__details">
          {place.guests} huespedes · {place.type} · {destination?.city}
        </p>
      </header>
      ...
      <div className="c-badges">
        <div className="c-badge">
          <div style={{ width: "auto", height: "32px" }}>
            <svg viewBox="0 0 20 32" fill="none" xmlns="http://www.w3.org/2000/svg" height="32">
              <g clip-path="url(#clip0_5880_37773)">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M8.32441 10.235C10.0819 8.96204 10.9247 7.4878 10.853 5.81232C10.7813 4.13685 9.80929 2.59524 7.93708 1.18749C6.17964 2.46049 5.33678 3.93473 5.40851 5.6102C5.48024 7.28568 6.45221 8.82729 8.32441 10.235Z" fill="#F7F7F7"></path>
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M15.6806 24.0529C14.1314 22.353 12.4326 21.4688 10.5842 21.4001C8.73575 21.3315 7.10737 22.0923 5.69905 23.6824C7.24822 25.3823 8.94702 26.2666 10.7955 26.3352C12.6439 26.4038 14.2723 25.6431 15.6806 24.0529Z" fill="#F7F7F7"></path>
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M10.6766 20.7043C10.2137 18.5957 9.16392 17.0928 7.52727 16.1956C5.89062 15.2984 3.99442 15.1864 1.83867 15.8596C2.30157 17.9683 3.35135 19.4712 4.988 20.3684C6.62465 21.2656 8.52085 21.3775 10.6766 20.7043Z" fill="#F7F7F7"></path>
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M7.90911 15.6267C8.65652 13.6743 8.53705 11.9555 7.55072 10.4702C6.56438 8.98484 4.90844 8.03014 2.58291 7.60605C1.8355 9.55846 1.95497 11.2773 2.9413 12.7626C3.92764 14.2479 5.58357 15.2026 7.90911 15.6267Z" fill="#F7F7F7"></path>
          ...
          <div style={{ width: "auto", height: "32px" }}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 32" fill="none" height="32">
              <g clip-path="url(#clip0_5880_37786)">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M11.2303 10.235C9.47283 8.96204 8.62998 7.4878 8.70171 5.81232C8.77344 4.13685 9.7454 2.59524 11.6176 1.18749C13.375 2.46049 14.2179 3.93473 14.1462 5.6102C14.0744 7.28568 13.1025 8.82729 11.2303 10.235Z" fill="#F7F7F7"></path>
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M3.87411 24.0529C5.42328 22.353 7.12208 21.4688 8.97051 21.4001C10.8189 21.3315 12.4473 22.0923 13.8556 23.6824C12.3065 25.3823 10.6077 26.2666 8.75924 26.3352C6.9108 26.4038 5.28243 25.6431 3.87411 24.0529Z" fill="#F7F7F7"></path>
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M8.87809 20.7043C9.34099 18.5957 10.3908 17.0928 12.0274 16.1956C13.6641 15.2984 15.5603 15.1864 17.716 15.8596C17.2531 17.9683 16.2033 19.4712 14.5667 20.3684C12.93 21.2656 11.0338 21.3775 8.87809 20.7043Z" fill="#F7F7F7" ></path>
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M11.6456 15.6267C10.8982 13.6743 11.0176 11.9555 12.004 10.4702C12.9903 8.98484 14.6462 8.03014 16.9718 7.60605C17.7192 9.55846 17.5997 11.2773 16.6134 12.7626C15.6271 14.2479 13.9711 15.2026 11.6456 15.6267Z" fill="#F7F7F7"></path>
        ...
        <div className="c-badge">
          <div>
            ...
            <div className="c-badge__subtext">★★★★★</div>
          </div>
        </div>
        <hr className="c-badge__division" />
        <div className="c-badge">
      ...
      <div className="c-host">
        ...
        <div className="c-host__info">
          ...
          <p className="c-host__badge">
            {host?.superhost && "Superanfitrión · "}
            {host?.yearsHosting} años anfitrionando
          </p>
        </div>
      </div>
      ...
      <section className="c-features">
        <article className="c-feature">
          ...
          <div>
            ...
            <p className="c-feature__description">
              Según los huéspedes, uno de los alojamientos más populares
              en Airbnb
            </p>
          </div>
        </article>
        <article className="c-feature">
          ...
          <div>
            ...
            <p className="c-feature__description">
              A los huéspedes recientes les encantó el buen comienzo de
              esta estancia.
            </p>
          </div>
        </article>
        <article className="c-feature">
          ...
          <div>
            <h3 className="c-feature__title">
              Zona protegida donde todo está muy bien
            </h3>
            <p className="c-feature__description">
              Los huéspedes dicen que esta zona es protegida y que es
              fácil moverse por ella.
            </p>
          </div>
        </article>
        <article className="c-feature">
          ...
          <div>
            <h3 className="c-feature__title">
              Cancelación gratuita antes del 22 nov
            </h3>
            <p className="c-feature__description">
      ...
      <section className="c-reviews">
        <div className="c-reviews__grid">
          <article className="c-review">
            ...
            <p className="c-review__text">
              Hilda fue excelente! Su alojamiento es hermoso, el espacio
              es de diseño muy creativo. El anfitrión hizo sentir muy bien
              tratado.
            </p>
          </article>
          <article className="c-review">
            ...
            <p className="c-review__text">
              La ubicación es perfecta para explorar Cusco. Las vistas
              desde el loft son impresionantes y Hilda fue muy atenta en
              todo momento.
            </p>
          </article>
          <article className="c-review">
            ...
            <p className="c-review__text">
              Excelente alojamiento en pleno centro de San Blas. La vista
              es increíble y el espacio es muy acogedor.
            </p>
          </article>
          <article className="c-review">
            <div className="c-review__header">
            ...
            <p className="c-review__text">
              Un lugar mágico con una anfitriona excepcional. Las
              escaleras de caracol son un detalle único que hace la
              experiencia especial.
            </p>
          </article>
        </div>
        <button className="c-reviews__button">
          Mostrar las 28 reseñas
        </button>
      </section>
      ...
      <section className="c-host-profile">
        ...
        <div className="c-host-profile__content">
          ...
          <div className="c-host-profile__info">
            <h3 className="c-host-profile__name">{host?.name}</h3>
