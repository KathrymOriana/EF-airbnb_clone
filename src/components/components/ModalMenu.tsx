...
const ModalMenu = ({ isOpen, onClose }: ModalMenuProps) => {
    ...
    return (
        <div className="modal modal--menu" ref={modalRef}>
            <ul className="modal__list">
                ...
                <li className="modal__item">
                    <a href="#" className="modal__link">
                        ...
                        <img src="https://a0.muscache.com/im/pictures/airbnb-platform-assets/AirbnbPlatformAssets-search-bar-icons/original/4aae4ed7-5939-4e76-b100-e69440ebeae4.png?im_w=240"
                            className="nav__icon" alt="" />
                    </a>
                </li>
                <hr className="modal__division" />
                <li className="modal__item">
                    <a href="#" className="modal__link">Encuentra un coanfitrión</a>
                </li>
                <hr className="modal__division" />
                <li className="modal__item">
